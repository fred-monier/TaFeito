...
public class OfertaDAO implements IDAO<Oferta> {
    ...
    private long inserir(Oferta oferta) {
        ...
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ID_SERVICO, oferta.getServico().getId());
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ANO_INICIO, calInicio.get(Calendar.YEAR));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_MES_INICIO, calInicio.get(Calendar.MONTH));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_DIA_INICIO, calInicio.get(Calendar.DAY_OF_MONTH));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_HORA_INICIO, calInicio.get(Calendar.HOUR_OF_DAY));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_MINUTO_INICIO, calInicio.get(Calendar.MINUTE));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ANO_FIM, calFim.get(Calendar.YEAR));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_MES_FIM, calFim.get(Calendar.MONTH));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_DIA_FIM, calFim.get(Calendar.DAY_OF_MONTH));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_HORA_FIM, calFim.get(Calendar.HOUR_OF_DAY));
        cv.put(BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_MINUTO_FIM, calFim.get(Calendar.MINUTE));

        long id = db.insert(BDSQLiteTaFeito.TABELA_OFERTA, null, cv);
    ...
    private int atualizar(Oferta oferta) {
        ...
        int linhasAlteradas = db.update(BDSQLiteTaFeito.TABELA_OFERTA, cv,
                BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ID + " = ?",
    ...
    public Oferta consultar(long id) {
        ...
        String sql = "SELECT * FROM " + BDSQLiteTaFeito.TABELA_OFERTA;
        ...
        sql = sql + " WHERE " + BDSQLiteTaFeito.TABELA_OFERTA + "." + BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ID + " = ?";
    ...
    public int excluir(Oferta oferta) {
        ...
        int linhasExcluidas = db.delete(BDSQLiteTaFeito.TABELA_OFERTA,
                BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ID + " = ?",
                new String[]{String.valueOf(oferta.getId())});
        db.close();
    ...
    public List<Oferta> listar() {
        ...
        //sql = sql + " WHERE " + BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_XXX + " = ?";
