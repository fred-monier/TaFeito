...
import br.pe.recife.monier.tafeito.negocio.Agendamento;
import br.pe.recife.monier.tafeito.negocio.Cliente;
import br.pe.recife.monier.tafeito.negocio.Fornecedor;
import br.pe.recife.monier.tafeito.negocio.Oferta;
...
public class AgendamentoDAO implements IDAO<Agendamento> {
    ...
    private long inserir(Agendamento agendamento) {
        ...
        cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ID_OFERTA, agendamento.getOferta().getId());
        cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ID_CLIENTE, agendamento.getCliente().getId());

        long id = db.insert(BDSQLiteTaFeito.TABELA_AGENDAMENTO, null, cv);
    ...
    private int atualizar(Agendamento agendamento) {
        ...
        if (calRealizado != null) {
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ANO_REALIZADO, calRealizado.get(Calendar.YEAR));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MES_REALIZADO, calRealizado.get(Calendar.MONTH));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_DIA_REALIZADO, calRealizado.get(Calendar.DAY_OF_MONTH));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_HORA_REALIZADO, calRealizado.get(Calendar.HOUR_OF_DAY));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MINUTO_REALIZADO, calRealizado.get(Calendar.MINUTE));
        } else {
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ANO_REALIZADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MES_REALIZADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_DIA_REALIZADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_HORA_REALIZADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MINUTO_REALIZADO);
        }
        if (calCancelado != null) {
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ANO_CANCELADO, calCancelado.get(Calendar.YEAR));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MES_CANCELADO, calCancelado.get(Calendar.MONTH));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_DIA_CANCELADO, calCancelado.get(Calendar.DAY_OF_MONTH));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_HORA_CANCELADO, calCancelado.get(Calendar.HOUR_OF_DAY));
            cv.put(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MINUTO_CANCELADO, calCancelado.get(Calendar.MINUTE));
        } else {
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ANO_CANCELADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MES_CANCELADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_DIA_CANCELADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_HORA_CANCELADO);
            cv.putNull(BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_MINUTO_CANCELADO);
        }

        int linhasAlteradas = db.update(BDSQLiteTaFeito.TABELA_AGENDAMENTO, cv,
                BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ID + " = ?",
    ...
    public Agendamento consultar(long id) {
        ...
        String sql = "SELECT * FROM " + BDSQLiteTaFeito.TABELA_AGENDAMENTO;

        sql = sql + " INNER JOIN " + BDSQLiteTaFeito.TABELA_OFERTA;
        sql = sql + " ON " + BDSQLiteTaFeito.TABELA_AGENDAMENTO + "." + BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ID_OFERTA;
        sql = sql + " = " + BDSQLiteTaFeito.TABELA_OFERTA + "." + BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ID;
        sql = sql + " INNER JOIN " + BDSQLiteTaFeito.TABELA_CLIENTE;
        sql = sql + " ON " + BDSQLiteTaFeito.TABELA_AGENDAMENTO + "." + BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ID_CLIENTE;
        ...
        sql = sql + " ON " + BDSQLiteTaFeito.TABELA_CLIENTE + "." + BDSQLiteTaFeito.TABELA_CLIENTE_COLUNA_ID;
        ...
        sql = sql + " ON " + BDSQLiteTaFeito.TABELA_OFERTA + "." + BDSQLiteTaFeito.TABELA_OFERTA_COLUNA_ID_SERVICO;
        sql = sql + " = " + BDSQLiteTaFeito.TABELA_SERVICO + "." + BDSQLiteTaFeito.TABELA_SERVICO_COLUNA_ID;
        ...
        sql = sql + " INNER JOIN " + BDSQLiteTaFeito.TABELA_USUARIO + " " + BDSQLiteTaFeito.TABELA_USUARIO + "2";
        sql = sql + " ON " + BDSQLiteTaFeito.TABELA_FORNECEDOR + "." + BDSQLiteTaFeito.TABELA_FORNECEDOR_COLUNA_ID;
        sql = sql + " = " + BDSQLiteTaFeito.TABELA_USUARIO + "2." + BDSQLiteTaFeito.TABELA_USUARIO_COLUNA_ID;

        sql = sql + " WHERE " + BDSQLiteTaFeito.TABELA_AGENDAMENTO + "." + BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ID + " = ?";
    ...
    public int excluir(Agendamento agendamento) {
        ...
        int linhasExcluidas = db.delete(BDSQLiteTaFeito.TABELA_AGENDAMENTO,
                BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_ID + " = ?",
                new String[]{String.valueOf(agendamento.getId())});
        db.close();
    ...
    public List<Agendamento> listar() {
        ...
        //sql = sql + " WHERE " + BDSQLiteTaFeito.TABELA_AGENDAMENTO_COLUNA_XXX + " = ?";
