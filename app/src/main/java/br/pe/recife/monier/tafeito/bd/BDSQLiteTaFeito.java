package br.pe.recife.monier.tafeito.bd;
...
public class BDSQLiteTaFeito extends SQLiteOpenHelper {

    private static BDSQLiteTaFeito instancia;
    ...
    public static BDSQLiteTaFeito getInstancia(Context context) {

        if (instancia == null) {
            instancia = new BDSQLiteTaFeito(context);
        }
        return instancia;
    }

    private BDSQLiteTaFeito(Context context) {
    ...
    private void popularServicoCategoria(SQLiteDatabase db) {
        ...
        cv.put(BDSQLiteTaFeito.TABELA_SERVICO_CATEGORIA_COLUNA_NOME, servicoCat.getNome());
        cv.put(BDSQLiteTaFeito.TABELA_SERVICO_CATEGORIA_COLUNA_DESCRICAO, servicoCat.getDescricao());
        id = db.insert(BDSQLiteTaFeito.TABELA_SERVICO_CATEGORIA, null, cv);
