...
public class MaskaraCpfCnpj {
    ...
    public static TextWatcher insert(final EditText editText, final MaskaraType maskType) {
        return new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                String value = MaskaraCpfCnpj.unmask(s.toString());
                String mask;
                switch (maskType) {
                    case CPF:
                        mask = CPFMask;
