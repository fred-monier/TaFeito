...
public class ClienteDAO implements IDAOson<Cliente> {
    ...
    private long inserir(Cliente cliente) {
        ...
        cv.put(BDSQLiteTaFeito.TABELA_CLIENTE_COLUNA_ID, cliente.getId());
        cv.put(BDSQLiteTaFeito.TABELA_CLIENTE_COLUNA_CPF, cliente.getCpf());

        long id = db.insert(BDSQLiteTaFeito.TABELA_CLIENTE, null, cv);
    ...
    private int atualizar(Cliente cliente) {
        ...
        int linhasAlteradas = db.update(BDSQLiteTaFeito.TABELA_CLIENTE, cv,
                BDSQLiteTaFeito.TABELA_CLIENTE_COLUNA_ID + " = ?",
    ...
    public Cliente consultar(long id) {
        ...
        String sql = "SELECT * FROM " + BDSQLiteTaFeito.TABELA_CLIENTE;
        ...
        sql = sql + " WHERE " + BDSQLiteTaFeito.TABELA_CLIENTE + "." + BDSQLiteTaFeito.TABELA_CLIENTE_COLUNA_ID + " = ?";
    ...
    public int excluir(Cliente cliente) {
        ...
        int linhasExcluidas = db.delete(BDSQLiteTaFeito.TABELA_CLIENTE,
                BDSQLiteTaFeito.TABELA_CLIENTE_COLUNA_ID + " = ?",
                new String[]{String.valueOf(cliente.getId())});
        db.close();
    ...
    public List<Cliente> listar() {
        ...
        //sql = sql + " WHERE " + BDSQLiteTaFeito.TABELA_CLIENTE_COLUNA_XXX + " = ?";
